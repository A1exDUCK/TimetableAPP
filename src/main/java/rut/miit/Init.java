...
public class Init implements CommandLineRunner {
    ...
    private void initAdmin(){
        ...
        var adminUser = new User("admin", passwordEncoder.encode(defaultPassword), "admin@example.com", "AlexDUCK");
    ...
    private void initModerator(){
        ...
        var moderatorUser = new User("moderator", passwordEncoder.encode(defaultPassword), "moderator@example.com", "Moderator S");
    ...
    private void initNormalUser(){
        ...
        var normalUser = new User("testUser", passwordEncoder.encode(defaultPassword), "user@example.com", "Test User");
